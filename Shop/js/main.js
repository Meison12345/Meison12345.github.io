...
class List {
     ...
     */
    getJson(url) {
        return fetch(url ? url : "https://raw.githubusercontent.com/Meison12345/JSON/Master/JSON_products")
...
class ProductItem extends Item {
    render() {
        return `<div class="product-item" data-id="${this.id_product}">
                ...
                <div class="desc">
                    <h3 class="desc__header">${this.product_name}</h3>
                    <p>${this.price} ₽</p>
...
class newFooter {
    ...
    insertData() {
        this.block = document.querySelector('.footer');
        this.block.innerHTML = new Date().getFullYear() + ' Все права защищены';
    }
}

let footer = new newFooter();